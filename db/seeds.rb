...
sata1 = Part.create!(name: "Sandisk Ultra II 240GB", description: "Standard 2.5\" SSD", price: 67, spec: "2.5\",SATA-3,240GB,Read: 450 MBs,Write: 450 MBs", image: "http://i.ebayimg.com/images/g/bE8AAOSwPCVX5CAA/s-l300.jpg")
sata2 = Part.create!(name: "WD Black 1TB", description: "3.5\" Storage drive", price: 71, spec: "3.5\",SATA-3,1TB,Read and Write appx 50 MBs", image: "https://askconrad.files.wordpress.com/2011/07/wd-wd1501fass.jpg")
sata3 = Part.create!(name: "Samsung 850 EVO 120GB", description: "High quality 2.5\" SSD", price: 80, spec: "2.5\",SATA-3,120GB,Read: 500+ MBs,Write: 500+ MBs", image: "http://i.ebayimg.com/images/g/AmUAAOSwB09YSSvZ/s-l300.jpg")

ssdM21 = Part.create!(name: "Samsung 950 EVO 500GB", description: "Top of the line NVMe M.2 SSD", price: 225, spec: "DDR3 Memory,500GB,NVMe M.2,Read: 3200MBs,Write: 1800MBs", image: "https://images-na.ssl-images-amazon.com/images/I/51cJkRd4mmL._SY300_.jpg")

cooler1 = Part.create!(name: "Coolermaster Hyper 212 EVO", description: "Low cost cooler for the average user", price: 25, spec: "4 Copper heatpipes,All modern sockets,Height: 159mm", image: "http://cdn.overclock.net/1/10/300x300px-LS-10367ade_B005O65JXI-51CZk9BjvUL.jpeg")
